...
- **【中】** フローチャート表示中のモーダル（詳細画面・改善要望を送る）内の文字入力が遅い
  - 2026-08-12 04:32 本番改善要望フォーム原文: 「フローチャートをひらいているうえのモーダル（詳細画面や改善要望を送る）のなかでの文字入力などの処理がすごく遅い。1文字に1秒くらいかかっている。原因調査して動作を早くしてほしい。codexにたのむのがよさそう。」
  - 未着手（原因調査から。発注者本人がCodex委譲を提案）

- **【中】** ステータス色の再調整（あとでやる→グレー、Inbox→緑、期限超過→薄い赤）
  - 2026-08-25 08:57 本番改善要望フォーム原文: 「ステータスが　あとでやる　の　色が　緑色ですが、これも目立たせる必要がないのでグレーにしてください。Inbox　のものを　この　緑色にしてください。　期限が超えたものは薄い赤色にしてください。」（スクリーンショット添付あり: `requests_sub_uploads/01a03635-6363-7615-9356-f25d65f7a4a9.png`、本番サーバー上）
  - 未着手
