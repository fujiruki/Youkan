...
export const ProjectCreationDialog: React.FC<ProjectCreationDialogProps> = ({
    ...
    // const youkanTenant = tenant as YoukanTenant; // Logic moved to registry
    ...
    // const isManufacturing = activeScope === 'company' && (youkanTenant?.config?.plugins?.manufacturing ?? false);
