...
// CloudYoukanRepository imported dynamically
...
export const ArchiveTrashScreen: React.FC<ArchiveTrashScreenProps> = ({ mode, onBack }) => {
    ...
    // Since CloudYoukanRepository is an object (not class), we use it directly or via getRepository if context needed.
    // For now assuming direct usage is fine or check imports.
    // Actually CloudYoukanRepository might be imported from '../repositories/CloudYoukanRepository'
