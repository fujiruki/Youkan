                ...
                <div className="flex-none flex flex-col border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 z-10">
                    ...
                    <div className="px-4 pb-3 pt-0">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {/* Due Date Input */}
                            <div className="w-[130px] flex flex-col md:flex-row items-start md:items-center gap-1 md:gap-2 p-1.5 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700">
