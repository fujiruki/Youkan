		...
		<>
            ...
            `}>
				...
				{onSwitchTenant && (
					<div className="px-3 py-2 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
						...
						<div className="space-y-1">
							...
							{(!tenant || (localStorage.getItem('youkan_show_life_mode') !== 'false')) && (
								<button
				...
				<div className="p-4 border-t border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-950">
					<div className="mb-3 rounded-md border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/70 px-3 py-2">
						<div className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
							Build
						</div>
						<div className="mt-0.5 font-mono text-[11px] font-semibold text-slate-600 dark:text-slate-300">
							{DEBUG_INFO.buildTime}
						</div>
					</div>
					<button
						onClick={onLogout}
